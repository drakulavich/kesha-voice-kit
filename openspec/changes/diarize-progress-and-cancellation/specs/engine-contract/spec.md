...
> | `KESHA_DIARIZE_TIMEOUT_SECS` | Engine | Cap total diarization wall time (seconds), overriding the per-phase budgets. Unset means no overall cap. Engine: `rust/src/transcribe/diarize.rs`. |
