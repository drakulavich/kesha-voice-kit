...
| **Capabilities JSON** | Protocol-3 name for the Engine's self-description (`kesha-engine --capabilities-json`), gone since `v1.25.0-beta.2`; the describe document replaced it. |
